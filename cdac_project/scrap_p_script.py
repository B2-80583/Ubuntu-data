...
for i in range(1, 10):
    ...
    if box is not None:
        for products_list_element in box.find_all("div", class_="_13oc-S"):
            ...
            # product_processor = products_list_element.find("li", class_="rgWa7D")
            # product_RAM = products_list_element.find("li", class_="rgWa7D")
            # product_OS = products_list_element.find("li", class_="rgWa7D")
            # product_memory = products_list_element.find("li", class_="rgWa7D")
            # product_Display = products_list_element.find("li", class_="rgWa7D")
            # warranty_info = products_list_element.find("li", class_="rgWa7D")
...
dataset.to_csv("flipkart_laptop_data_02.csv", index=False)
